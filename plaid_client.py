...
class PlaidClient:
    ...
    def create_link_token(
        self, user_id: str = "local-user", redirect_uri: str | None = None
    ) -> str:
        kwargs: dict = dict(
...
def _parse_transaction(t) -> dict:
    ...
    return {
        ...
        "date": str(t["date"]),
        "authorized_date": str(t["authorized_date"])
        if t.get("authorized_date")
        else None,
        "datetime": t.get("datetime"),
        "authorized_datetime": t.get("authorized_datetime"),
        "name": t["name"],
        "merchant_name": t.get("merchant_name"),
        "payment_channel": str(t.get("payment_channel"))
        if t.get("payment_channel")
        else None,
